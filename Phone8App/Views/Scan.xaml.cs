...
namespace AMIClaimReporter
{
    public partial class Scan : PhoneApplicationPage
    {
        ...
        private MainModel _mainModel = (new ViewModelLocator()).MainModel;
        ...
        void _bcReader_ResultFound(Result obj)
        {
            ...
            if (!obj.Text.Equals(tbBarcodeData.Text))
            {
                ...
                string[] words = obj.Text.Split('|');
                _mainModel.InsuredName = words[0];
                _mainModel.CustomerNo = words[1];
                _mainModel.InsuredDob = words[2];
